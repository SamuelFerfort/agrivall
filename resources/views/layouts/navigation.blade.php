<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('admin.dashboard') }}" class="text-xl font-bold text-green-700">
                        AGRIVALL Admin
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.tipo-posts.index')" :active="request()->routeIs('admin.tipo-posts.*')">
                        Tipos Post
                    </x-nav-link>
                    <x-nav-link :href="route('admin.semanas.index')" :active="request()->routeIs('admin.semanas.*')">
                        Semanas
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <a href="{{ route('home') }}" class="text-sm text-gray-500 hover:text-gray-700 mr-4">Ver Web</a>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.tipo-posts.index')" :active="request()->routeIs('admin.tipo-posts.*')">
                Tipos Post
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.semanas.index')" :active="request()->routeIs('admin.semanas.*')">
                Semanas
            </x-responsive-nav-link>
        </div>
